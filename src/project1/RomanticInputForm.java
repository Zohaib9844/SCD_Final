...
public class RomanticInputForm extends JFrame implements ActionListener {

    private static final String FILE_NAME = "romanticMovies.txt"; // Change this if your file name is different
    ...
    public RomanticInputForm() throws IOException {
